...
const ProductDetails = () => {
  ...
  useEffect(() => {
    fetch(`https://server.netflixbuy.com/product/${id}`)
      .then((res) => res.json())
  ...
  return (
    <section
      className="text-neutral-content body-font overflow-hidden"
      style={{
        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex">
              ...
              <span className="mx-10 title-font font-medium text-2xl line-through">
                {product?.oldPrice}$
              </span>
              <button
